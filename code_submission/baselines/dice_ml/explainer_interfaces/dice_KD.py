...
class DiceKD(ExplainerBase):
    ...
    def _generate_counterfactuals(self, query_instance, total_CFs, desired_range=None, desired_class="opposite",
        ...
        # find the prnedicted value of query_instance
        ...
        query_instance, cfs_preds, found = self.find_counterfactuals(data_df_copy,
    ...
    def find_counterfactuals(self, data_df_copy, query_instance, query_instance_orig, desired_range, desired_class,
        ...
        self.final_cfs, cfs_preds = self.vary_valid(query_instance_orig,    # query_instance_df_dummies
                                                    total_CFs,
                                                    features_to_vary,
                                                    permitted_range,
                                                    query_instance_orig,
        ...
        return query_instance, cfs_preds, total_cfs_found > 0
