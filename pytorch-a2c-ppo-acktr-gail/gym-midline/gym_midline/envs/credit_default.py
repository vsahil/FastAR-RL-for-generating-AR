...
class CreditDefault(gym.Env):
    ...
    def __init__(self, dist_lambda):
        ...
        file1 = "/scratch/vsahil/RL-for-Counterfactuals/paper_expts/default_redone.csv"    # 4 is also good
    ...
    def step(self, action):
        ...
        #     # For education 20 points means 4 levels -> 1 point 0.2 levels. Avg. age increase per education level is 4, therefore avg. age increase per point in this scale is 0.8 (in last example it was 2)
...
class CreditDefault1000(CreditDefault):
    def __init__(self, enable_render=True):
        super(CreditDefault1000, self).__init__(dist_lambda=1000.0)
